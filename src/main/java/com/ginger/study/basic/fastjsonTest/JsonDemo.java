package com.ginger.study.basic.fastjsonTest;
...
public class JsonDemo {
    ...
    public static void main(String[] args) {
        ...
        String ss = JSON.toJSONString(properties);

        String s = "{\"id\":\"0375\",\"city\":\"平顶山\"}";
        Properties properties1 = JSON.parseObject(s, Properties.class);
        System.out.println(properties1.getProperty("id"));

        Properties properties2 = JSON.parseObject(ss, Properties.class);
        System.out.println(properties2.getProperty("test2"));
        properties2.setProperty("test2","test3");
        properties2.setProperty("test4","test4");
        System.out.println(properties2.getProperty("test2"));
        System.out.println(properties2.getProperty("test4"));

        Properties propertiesJob = new Properties();
        propertiesJob.setProperty("jobConf",ss);
        System.out.println(propertiesJob.getProperty("jobConf"));
