...
/*	public void uploadFile(String localFile, String newName,
    ...
    public static void main(String[] args) throws Exception {
        ...
        ftpServerMap.put((String) SFTPConstants.SFTP_SERVER_HOST, "X.X.X.X");
        ftpServerMap.put((String) SFTPConstants.SFTP_SERVER_USERNAME, "XX");
        ftpServerMap.put((String) SFTPConstants.SFTP_SERVER_PASSWORD, "XXX");
